...
const TopBar = ({ setIsMobileOpen, darkMode, toggleDarkMode, sidebarCollapsed }) => {
  ...
  return (
    <div className="h-16 bg-white dark:bg-[#181818] border-b border-gray-200 dark:border-white/10 shadow-sm">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className={`hidden sm:flex flex-col items-end transition-all duration-300 ${
                ...
                <p className="text-sm font-medium text-gray-900 dark:text-gray-100 whitespace-nowrap">John Student</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Grade 12</p>
              </div>
