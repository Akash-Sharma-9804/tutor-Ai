    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-4 md:p-6 mb-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Search subjects by name, class, or school..."
            value={searchTerm}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="relative">
          <select
            ...
            className="w-full pl-4 pr-10 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent text-gray-800 dark:text-white appearance-none"
          >
        ...
        <div className="relative">
          <select
            ...
            className={`w-full pl-4 pr-10 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent text-gray-800 dark:text-white appearance-none ${
              !selectedSchool
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <p className="text-gray-600 dark:text-gray-300">
          Showing <span className="font-bold text-gray-800 dark:text-white">{filteredSubjects.length}</span>{" "}
          of <span className="font-bold text-gray-800 dark:text-white">{totalSubjects}</span> subjects
        </p>
        {(searchTerm || selectedSchool || selectedClass) && (
          <button
