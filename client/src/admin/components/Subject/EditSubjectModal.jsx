...
const EditSubjectModal = ({ subject, formData, onInputChange, onSubmit, onClose, classes }) => {
  return (
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6">
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="flex gap-3">
            <button
              type="submit"
              className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-500 dark:to-pink-500 text-white font-bold rounded-xl hover:from-purple-700 hover:to-pink-700 dark:hover:from-purple-600 dark:hover:to-pink-600 transition-all"
            >
              Update Subject
            </button>
            <button
