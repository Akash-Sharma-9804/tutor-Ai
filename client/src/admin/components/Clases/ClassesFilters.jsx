    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-4 md:p-6 mb-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <p className="text-gray-600 dark:text-gray-300">
          Showing <span className="font-bold text-gray-800 dark:text-white">{filteredClasses.length}</span>{" "}
          of <span className="font-bold text-gray-800 dark:text-white">{totalClasses}</span> classes
        </p>
